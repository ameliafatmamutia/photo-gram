...
function ProfileForm({ backHandler, fullnameInitial, bioInitial }) {
    ...
    const updateUserById = async () => {
        try {
            ...
            const response = await axios.put(`http://localhost:8000/api/users/data/${id_user}`, formData, {
                headers: {
    ...
    return (
        <Grid container direction="column" spacing={2}>
            ...
            <Grid item container alignItems="center">
                <Button disabled={disabled} sx={{ marginRight: 10 }} onClick={updateUserById} variant="contained" color="primary">
                    Save Profile
                </Button>
